...
for _, motion in pairs(motions) do
  ...
  o.bind(mainMod .. " + " .. string.upper(motion.key), "Focus on " .. motion.mov .. " window", hl.dsp.focus({ direction = motion.dir }))
  o.bind(mainMod .. " + SHIFT + " .. string.upper(motion.key), "Swap window" .. motion.mov .. " window", hl.dsp.window.swap({ direction = motion.dir }))
end
